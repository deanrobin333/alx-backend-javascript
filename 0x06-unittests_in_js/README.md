...
- [Tasks](#tasks)
	- [0. Basic test with Mocha and Node assertion library](#0)
	- [1. Combining descriptions](#1)
	- [2. Basic test using Chai assertion library](#2)
	- [3. Spies](#3)
	- [4. Stubs](#4)
	- [5. Hooks](#5)
	- [6. Async tests with done](#6)
	- [7. Skip](#7)
	- [8. Basic Integration testing](#8)
	- [9. Regex integration testing](#9)
	- [10. Deep equality & Post integration testing](#10)
---
## Author Details
...
- Repo
    - GitHub repository: `alx-backend-javascript`
    - Directory: `0x06-unittests_in_js`
    - File: [`5-payment.js`](./5-payment.js)
...
- Repo
    ...
    - File: [`8-api/api.test.js`](./8-api/api.test.js)
---
#### 9
###### [Table of Contents](#table-of-contents)
