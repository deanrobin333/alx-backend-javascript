...
- [Tasks](#tasks)
	- [0. Keep every promise you make and only make promises you can keep](#0)
	- [1. Don't make a promise...if you know you can't keep it](#1)
	- [2. Catch me if you can!](#2)
	- [3. Handle multiple successful promises](#3)
	- [4. Simple promise](#4)
	- [5. Reject the promises](#5)
	- [6. Handle multiple promises](#6)
	- [7. Load balancer](#7)
	- [8. Throw error / try catch](#8)
	- [9. Throw an error](#9)
	- [10. Await / Async](#10)
---
## Author Details
